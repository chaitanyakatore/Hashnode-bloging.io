...
- [Maths for data science -Youtube(codebasics)](https://www.youtube.com/playlist?list=PLeo1K3hjS3uuKaU2nBDwr6zrSOTzNCs0l)
- [Maths for data science -Udemy(Jose Portilla,Krista King)](https://www.udemy.com/share/107qEq/)
- [Maths for data science -GFG(GeeksForGeeks)](https://www.geeksforgeeks.org/maths-for-data-science/)

### Probabiliity

- [Probability for data science -Khan Academy](https://www.khanacademy.org/math/statistics-probability/probability-library)
- [Probability for data science -Probability4datascience(Stanley H. Chan)](https://probability4datascience.com/ch02.html)
- [Intro to Probability(Joseph K. Blitzstein, Jessica Hwang)](https://drive.google.com/file/d/15Y0oFNHQRls1qvQNvO3DFLJVhIZvUjTD/view?usp=sharing)

### Statistics

- [Statistics for data science -Youtube(Great Learning)](https://youtu.be/Vfo5le26IhY)
- [Statistics for data science -Youtube(freecodeCamp.org)](https://youtu.be/xxpc-HPKN28)
- [Statistics for data science -Youtube(StatQuest with Josh Starmer)](https://youtube.com/playlist?list=PLblh5JKOoLUK0FLuzwntyYI10UQFUhsY9)
- [Statistics for data science -Youtube(CampusX)](https://youtu.be/DUT4WEUngt0)
- [Statistics for data science -Udacity](https://www.udacity.com/course/intro-to-descriptive-statistics--ud827)
- [Statistics for data science -towardsdatascience(Tatev Karen Aslanyan)](https://towardsdatascience.com/fundamentals-of-statistics-for-data-scientists-and-data-analysts-69d93a05aae7)

### Programming Languages

- [R - good tool for visualization and statistical analysis.]

  - [R programming language -Youtube(freeCodeCamp.org)](https://youtu.be/_V8eKsto3Ug)
  - [R programming language -Youtube(Simplilearn)](https://youtu.be/iROHLA_TXQM)
  - [R programming language -GFG(GeeksForGeeks)](https://www.geeksforgeeks.org/r-programming-language-introduction/)
  - [R programming language -W3schools(W3schools.com)](https://www.w3schools.com/r/)
  - [R programming language -R for datascience(Hadley Wickham)](https://r4ds.had.co.nz/)

- [Python]

  - [Python programming language -Youtube(TechWorld with Nana)](https://youtu.be/t8pPdKYpowI)
  - [Python programming language -Youtube(Programming with Mosh)](https://youtu.be/_uQrJ0TkZlc)
  - [Python programming language -Youtube(freeCodeCamp.org)](https://youtu.be/nLRL_NcnK-4)
  - [Python programming language -Youtube(freeCodeCamp.org)](https://youtu.be/eWRfhZUzrAc)
...
- [SQL]
  - [SQL for Data Analysis -Youtube(freeCodeCamp.org)](https://youtu.be/HXV3zeQKqGY)
  - [SQL for Data Analysis -Youtube(Programming With Mosh)](https://youtu.be/7S_tz1z_5bA)
...
- [Python Pandas -Youtube(Corey Schafer)](https://youtube.com/playlist?list=PL-osiE80TeTsWmV9i9c58mdDCSskIFdDS)
- [Python Pandas -Youtube(Data School)](https://youtube.com/playlist?list=PL5-da3qGB5IBITZj_dYSFqnd_15JgqwA6)
- [Python Pandas -Kaggle(Kaggle.com)](https://www.kaggle.com/learn/pandas)
- [Python Pandas -Pandas.pydata(Pandas.pydata.org)](https://pandas.pydata.org/pandas-docs/version/0.15/tutorials.html)

### Numpy

- [Python Numpy -Youtube(freeCodeCamp.org)](https://youtu.be/QUT1VHiLmmI)
- [Python Numpy -Youtube(Simplilearn)](https://youtu.be/j31ah5Qa4QI)
- [Python Numpy course -Kaggle(Kaggle.com)](https://www.kaggle.com/code/legendadnan/numpy-tutorial-for-beginners-data-science/notebook)
- [Python Numpy -Github(cs231n)](https://cs231n.github.io/python-numpy-tutorial/)
- [Python Numpy -Numpy(numpy.org)](https://numpy.org/doc/1.18/user/quickstart.html)
...
- [Data Cleaning -datacamp(app.datacamp.com)](https://app.datacamp.com/learn/courses/cleaning-data-in-python)
...
- [Data Visualization -Youtube(Corey Schafer)](https://www.youtube.com/watch?v=UO98lJQ3QGI&list=PL-osiE80TeTvipOqomVEeZ1HRrcEvtZB_)
- [Data Visualization -Youtube(sentdex)](https://www.youtube.com/watch?v=q7Bo_J8x_dw&list=PLQVvvaa0QuDfefDfXb9Yf0la1fPDKluPF)
- [Data Visualization -Youtube(Intellipaat)](https://www.youtube.com/live/_YWwU-gJI5U?feature=share)
...
- [EDA -Youtube(Krish Naik)](https://youtu.be/fHFOANOHwh8)
- [EDA -Youtube(Simplilearn)](https://youtu.be/MoM6mighOJM)
- [EDA -datacamp(datacamp.com)](https://learn.datacamp.com/courses/exploratory-data-analysis-in-python)
- [EDA -coursera(coursera.com)](https://www.coursera.org/learn/ibm-exploratory-data-analysis-for-machine-learning)
